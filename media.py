...
class Video():  # A superclass about Videos

    '''a class for videos. Currently only with attribute title (str).'''
...
class Movie(Video):  # The Movie-Class (inheriting Video)
    ...
    '''a class for movies.
       ...
       additionally keeps the attributes:
            ...
            poster_image_url (str): url pointing to a picture poster
                                    of the movie
            trailer_youtube_url (str): url pointing to the trailer of
                                       the video on youtube

        movie_title, movie_storyline, poster_image_url and trailer_youtube_url
        need to be passed in on initialisation of any class instance
